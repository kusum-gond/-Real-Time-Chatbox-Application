...
elseif(mysqli_num_rows($c)==1)
		...
		{	$color = $_POST['color'];
			$p3=sha1($p1);
			$sql=mysqli_query($al,"INSERT INTO users(name,nick,dob,email,contact,password,date,color,status) VALUES('$name','$nname','$dob','$email','$contact','$p3','$date','$color','0')");
			if($sql) {
...
<tr><td class="labels">Nick Name Color : </td><td><input type="color" name="color" size="40" class="fields" required="required" value="#ffd500" /></td></tr>
