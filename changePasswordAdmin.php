...
<tr><td class="labels">Enter Old Password :</td><td><input type="password" name="old" size="25" class="fields" required="required" placeholder="Enter Old Password" /></td></tr>
<tr><td class="labels">Enter New Password :</td><td><input type="password" name="p1" size="25" class="fields" required="required" placeholder="Enter New Password"  /></td></tr>
<tr><td class="labels">Re-Type New Password :</td><td><input type="password" name="p2" size="25"  class="fields" required="required" placeholder="Retype New Password" /></td></tr>
